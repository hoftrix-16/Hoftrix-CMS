    ...
    <div className="p-4" id="employee-profile-container">
      <style>
        {`
          ...
          .info-label { font-size: 0.75rem; font-weight: 700; color: #9ca3af; text-transform: uppercase; margin-bottom: 0.25rem; letter-spacing: 0.04em; }
          .info-value { font-size: 1rem; font-weight: 600; color: #f3f4f6; word-break: break-word; }
          .info-value.text-success { color: #3dd68c !important; }
        `}
      </style>
                 ...
                 <CardBody className="p-4">
                    ...
                    {employee.email && (
                      <div className="mt-3 pt-3 border-top">
                        <p className="info-label mb-1">Employee Login</p>
                        <p className="info-value small mb-1">{employee.email}</p>
                        <p className="small mb-0" style={{ color: '#9ca3af' }}>
                          Same login page as admin. First password = server default (or after Reset Password).
                        </p>
                      </div>
                    )}
                 </CardBody>
